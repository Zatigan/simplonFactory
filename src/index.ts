...
const chemise = new Clothing(2, "Chemise hawaienne", 1, 25.97, ClothingSize.XL);
...
// console.log(gegeOrder.calculateWeight());
...
gegeOrder.displayOrder();
console.log(gegeOrder.displayOrder());
